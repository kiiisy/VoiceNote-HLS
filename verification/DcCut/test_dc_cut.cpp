...
{
    double rmse = 0.0;
    ASSERT_TRUE(run_dc_cut_case(1, "dc_cut_case1", rmse)) << "RMSE=" << rmse;
}

TEST(DcCut, Case2)
{
    double rmse = 0.0;
    ASSERT_TRUE(run_dc_cut_case(2, "dc_cut_case2", rmse)) << "RMSE=" << rmse;
}

TEST(DcCut, Case3)
{
    double rmse = 0.0;
    ASSERT_TRUE(run_dc_cut_case(3, "dc_cut_case3", rmse)) << "RMSE=" << rmse;
}

TEST(DcCut, Case4)
{
    double rmse = 0.0;
    ASSERT_TRUE(run_dc_cut_case(4, "dc_cut_case4", rmse)) << "RMSE=" << rmse;
}

TEST(DcCut, Case5)
{
    double rmse = 0.0;
    ASSERT_TRUE(run_dc_cut_case(5, "dc_cut_case5", rmse)) << "RMSE=" << rmse;
}
